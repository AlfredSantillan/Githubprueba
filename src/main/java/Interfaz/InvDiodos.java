...
public class InvDiodos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TablaDiodos = new javax.swing.JTable();
        ...
        TablaDiodos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jScrollPane1.setViewportView(TablaDiodos);
    ...
    private void BtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEliminarActionPerformed
        ...
        if (TablaDiodos.getRowCount() > 0) {
            if (TablaDiodos.getSelectedRow() != -1) {
                int id = (int) TablaDiodos.getValueAt(TablaDiodos.getSelectedRow(), 0);
                control.borrarDio(id);
                m2.mostrarMensaje("Diodo borrado correctamente", "Borrado exitoso", "Info");
                CargarDio();
            } else {
                m2.mostrarMensaje("No se seleccionó diodo para borrar", "Borrado fallido", "Falla");
                CargarDio();
            }
        } else {
    ...
    private void BtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditarActionPerformed
        ...
        if (TablaDiodos.getRowCount() > 0) {
            if (TablaDiodos.getSelectedRow() != -1) {
                ...
                ModificacionDio mdio = new ModificacionDio(id);
                mdio.setVisible(true);
                mdio.setLocationRelativeTo(null);
                dispose();
            } else {
                m2.mostrarMensaje("No se selecciono diodo para editar", "Editado Fallido", "Falla");
            }
        } else {
    ...
    private void BtnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBuscarActionPerformed
        DefaultTableModel TablaDio = new DefaultTableModel() {
        ...
        TablaDio.setColumnIdentifiers(titulos);
        List<Diodos> ListaDio = control.traerDio();

        if (ListaDio != null) {
            for (Diodos dio : ListaDio) {
                if (BoxBuscar.getSelectedIndex() == 0) {
                    String xd = txtBuscar.getText();
                    String id = dio.getMatricula_dio();
                    boolean resul = id.contains(xd);
                    if (resul == true) {
                        Object[] objeto = {dio.getId(), dio.getGabeta_dio(), dio.getCaja_dio(), dio.getMatricula_dio(), dio.getCaracteristicas_dio(), dio.getCantidad_dio()};
                        TablaDio.addRow(objeto);

                    }
                }
                if (BoxBuscar.getSelectedIndex() == 2) {
                    String xd = txtBuscar.getText();
                    String id = dio.getCaracteristicas_dio();
                    boolean resul = id.contains(xd);
                    if (resul == true) {
                        Object[] objeto = {dio.getId(), dio.getGabeta_dio(), dio.getCaja_dio(), dio.getMatricula_dio(), dio.getCaracteristicas_dio(), dio.getCantidad_dio()};
                        TablaDio.addRow(objeto);
                ...
                if (BoxBuscar.getSelectedIndex() == 1) {
                    String xd = txtBuscar.getText();
                    String id = String.valueOf(dio.getId());
                    boolean resul = id.contains(xd);
                    if (resul == true) {
                        Object[] objeto = {dio.getId(), dio.getGabeta_dio(), dio.getCaja_dio(), dio.getMatricula_dio(), dio.getCaracteristicas_dio(), dio.getCantidad_dio()};
                        TablaDio.addRow(objeto);
    ...
    private void BtnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCargarActionPerformed
        ...
        Diodo dio = new Diodo();
        dio.setVisible(true);
        dio.setLocationRelativeTo(null);
        dispose();
    ...
    private javax.swing.JTable TablaDiodos;
    ...
    private void tamañoColu() {
        TablaDiodos.getColumnModel().getColumn(0).setPreferredWidth(20);
        TablaDiodos.getColumnModel().getColumn(1).setPreferredWidth(20);
        TablaDiodos.getColumnModel().getColumn(2).setPreferredWidth(20);
        TablaDiodos.getColumnModel().getColumn(3).setPreferredWidth(40);
        TablaDiodos.getColumnModel().getColumn(4).setPreferredWidth(150);
        TablaDiodos.getColumnModel().getColumn(5).setPreferredWidth(20);
    }
